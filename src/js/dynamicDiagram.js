    ...
    if(this.shapeList.length > 0){
      for(i = 0; i<this.shapeList.length ; i++){
        ...
        var tempText = new this.createText(this.ctx,
            {x: this.shapeList.x,y: this.shapeList.y},
            {key: this.shapeList[i].key, value: this.shapeList[i].value});
        this.shapeList[i].render = temp.render;
        this.shapeList[i].text.render = tempText.render;
        this.shapeList[i].text.ctx = this.ctx;
      }
      this.reRender();
    }
